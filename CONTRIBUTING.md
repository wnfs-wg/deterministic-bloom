# Contributing to deterministic-bloom
...
The main way to get help is on our [discord server](https://discord.gg/fissioncodes).server][https://discord.gg/fissioncodes].
...
need to be the best programmer to contribute. Our discord is open for questions
 ...
 6. **Build** the project
    - For a detailed look on how to build deterministic-bloom look at our
